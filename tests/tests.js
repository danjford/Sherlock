...
var dates = [
  ...
  new Date("April 27, 2026 22:34:40"),
...
function runTestCases(sherlock, verbose) {
  ...
  (function() {
    var now = getNow(),
    start = new Date(now.getFullYear(), 11, 10);
    end   = new Date(now.getFullYear() + 1, 0, 20);

    return test("12/10 through 1/20.", null, start, end, true);
  })(),
  ...
  (function() {
    ...
    return test("12/10 through 12/15.", null, start, end, true);
  })(),
  ...
  (function() {
    ...
    return test("12/10 through 1/15/2019.", null, start, end, true);
  })(),
  ...
  (function() {
    return test("10-27-1990", null, new Date(1990, 9, 27), null, true);
  })(),

  (function() {
    return test("10-27-90", null, new Date(1990, 9, 27), null, true);
  })(),

  (function() {
    return test("My favorite year was 1-1-04 - 01-2-05", "My favorite year", new Date(2004, 0, 1), new Date(2005, 0, 2), true);
  })(),

  (function() {
    return test("1990-10-27", null, new Date(1990, 9, 27), null, true);
  })(),
  ...
  (function() {
    ...
    return test("3 hrs from now", null, start, null, false);
  })(),
  ...
  (function() {
    ...
    return test("3 hr from now", null, start, null, false);
  })(),
  ...
  (function() {
    ...
    return test("Send those four emails before leaving work today by 1800", "Send those four emails before leaving work", start, null, false);
  })(),
